...
import threading
import sys
sys.path.insert(0,"/JARVIS/global/")
import gui as gui 
from speech import speak, listen
from conv import converse
from actions import open_notepad, open_word, open_excel, open_ppt, open_calculator, open_cmd, take_screenshot, start_screen_record, stop_screen_record, open_camera, camera_vision, open_website
